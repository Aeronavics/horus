...
local function drawPane(x,drawLib,conf,telemetry,status,alarms,battery,utils)
  lcd.setColor(CUSTOM_COLOR,0xFFFF) -- white
  -- battery voltage
  lcd.drawNumber(x+95, 16, telemetry.sid , DBLSIZE+RIGHT)
  lcd.setColor(CUSTOM_COLOR,0x0000)
  lcd.drawText(x+95, 56, "AC SID", SMLSIZE+RIGHT+CUSTOM_COLOR)
